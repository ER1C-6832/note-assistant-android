...
/** Android platform Opus decoder wrapper for Xiaozhi binary downlink frames. */
class AndroidOpusDecoder {
    ...
    private fun queueInput(packet: ByteArray) {
        ...
        if (inputIndex < 0) throw OpusEncodingException("Opus 解码器暂时没有可用输入缓冲区")
