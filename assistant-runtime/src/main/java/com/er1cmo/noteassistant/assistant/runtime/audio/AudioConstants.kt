...
object AudioConstants {
    ...
    /**
     * Android MediaCodec Opus decoder commonly outputs 48 kHz PCM even when the
     * logical stream is described as 24 kHz. Keep AudioTrack aligned with the
     * actual decoder output rate, mirroring the xiaozhi-android implementation.
     */
